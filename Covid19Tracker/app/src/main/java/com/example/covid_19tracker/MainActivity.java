...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvAffectedCountries = findViewById(R.id.tvAfectedCountries);
    ...
    public void goTrackCountries(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(),AffecrtedCountries.class);
        startActivity(intent);

    }

    public StringBuffer changeString(String str){
