...
public  abstract class OfferingPlansListSwipeController extends ItemTouchHelper.SimpleCallback {
    ...
    public OfferingPlansListSwipeController(Context context, RecyclerView recyclerView) {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        buttonsBuffer.clear();
        swipeThreshold = 0.3f * buttons.size() * BUTTON_WIDTH;
        recoverSwipedItem();
    }
